...
def generate_guideline():
    try:
        ...
        location = data.get('location', 'Dhaka, Bangladesh') # লোকেশন রিসিভ করা হচ্ছে

        print(f"--- Requesting Independent Assessment for Patient in {location} ---")

        # 🚀 NEW: প্রম্পটে নির্দিষ্ট ডাক্তারের নাম, চেম্বার এবং নম্বর চাওয়ার কড়া নির্দেশ
        prompt = (
            ...
            f"৫. রোগীর বর্তমান অবস্থান ({location}) এবং '{disease_name}' বিবেচনা করে, ওই এলাকার ২-৩ জন সুপরিচিত বিশেষজ্ঞ ডাক্তারের (Specialist) নাম, তাদের চেম্বার বা হাসপাতালের সুনির্দিষ্ট ঠিকানা এবং সম্ভব হলে যোগাযোগের নম্বর সাজেস্ট করবে। ঢালাওভাবে কথা না বলে নির্দিষ্ট ডাক্তারের নাম উল্লেখ করতে হবে।\n"
            ...
            f"অংশ ৩: চিকিৎসকের সিরিয়াল (লোকেশন অনুযায়ী ২-৩ জন বিশেষজ্ঞ ডাক্তারের নাম, চেম্বারের ঠিকানা ও যোগাযোগের তথ্য)"
        )
