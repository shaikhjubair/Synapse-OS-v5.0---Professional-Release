...
def generate_guideline():
    try:
        ...
        location = data.get('location', 'Bangladesh') # 🚀 NEW: লোকেশন রিসিভ করা হচ্ছে

        print(f"--- Requesting Independent Assessment for Patient in {location} ---")

        # 🚀 NEW: প্রম্পটে লোকেশন এবং স্পেশালিস্ট রেকমেন্ডেশনের ইনস্ট্রাকশন
        prompt = (
            ...
            f"৫. রোগীর বর্তমান অবস্থান ({location}) বিবেচনা করে, তাকে কোন ধরনের বিশেষজ্ঞ ডাক্তারের (Specialist) কাছে যেতে হবে এবং ওই এলাকার আশপাশে কী ধরনের স্পেশালাইজড হাসপাতালে যাওয়া উচিত, তার সুনির্দিষ্ট পরামর্শ দেবে।\n"
            ...
            f"অংশ ৩: চিকিৎসা পরামর্শ (লোকেশন অনুযায়ী বিশেষজ্ঞ ডাক্তারের পরামর্শ)"
        )
