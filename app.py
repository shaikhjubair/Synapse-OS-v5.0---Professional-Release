...
def generate_guideline():
    try:
        ...
        prompt = (
            ...
            f"৪. রোগীর চিকিৎসার জন্য নিচে দেওয়া চিকিৎসকদের তালিকা হুবহু ব্যবহার করে 'চিকিৎসকের সিরিয়াল' অংশে দেখাবে:\n"
            f"{suggested_doctors}\n"
        ...
        try:
            try:
                # 🚀 FIX: gemini-2.0-flash ব্যবহার করা হলো
            ...
            print(f"All AI Models Failed: {e_ai}")
            # ব্যাকএন্ড ফেইল করলেও 200 Success স্ট্যাটাস পাঠাবে যাতে ফ্রন্টএন্ড ক্র্যাশ না করে
            fallback_text = (
                f"**অংশ ১: ক্লিনিক্যাল অ্যাসেসমেন্ট**\n"
