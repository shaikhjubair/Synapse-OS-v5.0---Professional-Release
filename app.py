...
def generate_guideline():
    try:
        ...
        try:
            ...
            # 🚀 FIX: এখন আর * বা # রিমুভ করা হবে না, শুধু ` রিমুভ করা হবে যাতে ফ্রন্টএন্ড সুন্দর করে ফরম্যাট করতে পারে।
            ...
            fallback_text = (
                f"**অংশ ১: ক্লিনিক্যাল অ্যাসেসমেন্ট**\n"
                f"আপনার ল্যাব রিপোর্ট বিশ্লেষণ করে দেখা যাচ্ছে যে '{disease_name}' এর ঝুঁকি রয়েছে। দ্রুত নিয়ন্ত্রণ প্রয়োজন।\n\n"
                f"**অংশ ২: গাইডলাইন**\n"
                f"* পর্যাপ্ত বিশ্রাম নিন এবং বিশুদ্ধ পানি পান করুন।\n* প্রক্রিয়াজাত খাবার এড়িয়ে চলুন।\n\n"
                f"**অংশ ৩: চিকিৎসকের সিরিয়াল**\n"
                f"আপনার বর্তমান অবস্থান ({location}) বিবেচনা করে, নিচের বিশেষজ্ঞের পরামর্শ নেওয়ার সুপারিশ করা হচ্ছে:\n{suggested_doctors}\n\n"
