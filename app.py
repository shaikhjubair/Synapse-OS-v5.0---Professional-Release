...
def generate_guideline():
    try:
        ...
        prompt = (
            ...
            f"২. কোনো ধরনের ভূমিকা বা বিদায়ী কথা লেখা যাবে না।\n"
            f"৩. গুরুত্বপূর্ণ পয়েন্টগুলো সুন্দর করে বুলেট পয়েন্ট (*) এবং সাব-হেডিং বোল্ড (**) করে সাজিয়ে লিখবে।\n"
            f"৪. Vercel সার্ভারের টাইমআউট এড়াতে উত্তরটি খুব সংক্ষেপে এবং টু-দ্য-পয়েন্টে (Concise) দেবে।\n"
            f"৫. রোগীর চিকিৎসার জন্য নিচে দেওয়া চিকিৎসকদের তালিকা হুবহু ব্যবহার করে 'চিকিৎসকের সিরিয়াল' অংশে দেখাবে:\n"
            f"{suggested_doctors}\n"
        ...
        try:
            # 🚀 FASTEST MODEL: Vercel এ 10s এর মধ্যে রেসপন্স পাওয়ার জন্য gemini-2.5-flash
            ...
            print(f"AI Model Failed: {e_ai}")
            # যদি এরপরও 10s পার হয়ে যায়, শুধুমাত্র তখনই এই ডামিটা যাবে
            fallback_text = (
                f"**অংশ ১: ক্লিনিক্যাল অ্যাসেসমেন্ট**\n"
