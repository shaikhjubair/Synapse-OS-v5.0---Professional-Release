...
# ... [তোমার অন্যান্য ইমপোর্ট এবং কোড] ...
...
def generate_guideline():
    try:
        ...
        # 🚀 NEW: রোগ অনুযায়ী সঠিক ক্যাটাগরির ডাক্তার সিলেক্ট করা
        ...
        # প্রম্পট আপডেট: এআইকে বাধ্য করা হচ্ছে আমাদের ডাটাবেসের ডাক্তারদের নাম দিতে
        prompt = (
            ...
            f"২. কোনো ধরনের ভূমিকা, সম্ভাষণ (যেমন: 'হ্যালো', 'স্বাগতম') বা বিদায়ী কথা (যেমন: 'ধন্যবাদ', 'সুস্থ থাকুন') লেখা যাবে না। সরাসরি মূল কথায় আসবে।\n"
            ...
            f"৫. রোগীর চিকিৎসার জন্য নিচে দেওয়া চিকিৎসকদের তালিকা হুবহু ব্যবহার করে 'চিকিৎসকের সিরিয়াল' অংশে দেখাবে। কোনো পরিবর্তন করবে না:\n"
            f"{suggested_doctors}\n"
