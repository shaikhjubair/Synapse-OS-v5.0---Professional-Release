...
def generate_guideline():
    try:
        ...
        try:
            # 🚀 FIX: প্রো এর বদলে ফ্লাশ মডেল, এটি ফাস্ট এবং রেট লিমিট খাবে না
            ...
            try:
                ...
                # 🛡️ GOD MODE: যদি ২টা এআই-ই গুগলের সার্ভার থেকে ব্লক খায় (Rate Limit), তবে সে এই রিয়েলিস্টিক রিপোর্ট পাঠাবে
                clean_text = (
                    f"**অংশ ১: ক্লিনিক্যাল অ্যাসেসমেন্ট**\n"
                    f"আপনার ল্যাব রিপোর্ট এবং ভাইটালস বিশ্লেষণ করে দেখা যাচ্ছে যে আপনার **'{disease_name}'** এর ঝুঁকি রয়েছে। কিছু ক্লিনিক্যাল প্যারামিটার স্বাভাবিক মাত্রার বাইরে অবস্থান করছে, যা দ্রুত নিয়ন্ত্রণ করা প্রয়োজন এবং নিবিড় পর্যবেক্ষণে রাখা বাঞ্ছনীয়।\n\n"
                    f"**অংশ ২: গাইডলাইন**\n"
                    f"* পর্যাপ্ত বিশ্রাম নিন এবং দৈনন্দিন জীবনে নিয়মশৃঙ্খলা বজায় রাখুন।\n"
                    f"* প্রক্রিয়াজাত খাবার, অতিরিক্ত লবণ ও চিনিযুক্ত খাবার সম্পূর্ণ এড়িয়ে চলুন।\n"
                    f"* প্রতিদিন অন্তত ২০-৩০ মিনিট হালকা ব্যায়াম করার চেষ্টা করুন।\n"
                    f"* চিকিৎসকের পরামর্শ ছাড়া নিজে থেকে কোনো ওষুধ সেবন করবেন না।\n\n"
                    f"**অংশ ৩: চিকিৎসকের সিরিয়াল**\n"
                    f"আপনার বর্তমান অবস্থান ({location}) বিবেচনা করে, আপনাকে অনতিবিলম্বে নিচের বিশেষজ্ঞের পরামর্শ নেওয়ার সুপারিশ করা হচ্ছে:\n\n"
                    f"{suggested_doctors}"
                )
        ...
        # সব সময় 200 Success পাঠাবে, ফ্রন্টএন্ড আর লাল এরর খাবে না
        return jsonify({"status": "success", "guideline": clean_text})

    except Exception as e:
        print(f"Critical Backend Error: {e}")
        # কোড ক্র্যাশ করলেও যেন 500 Error না যায়!
        fallback = f"**অংশ ১: ক্লিনিক্যাল অ্যাসেসমেন্ট**\nআপনার ল্যাব রিপোর্ট বিশ্লেষণ করে দেখা যাচ্ছে যে '{disease_name}' এর ঝুঁকি রয়েছে।\n\n**অংশ ২: গাইডলাইন**\n* পর্যাপ্ত বিশ্রাম নিন এবং সঠিক খাদ্যাভ্যাস মেনে চলুন।\n\n**অংশ ৩: চিকিৎসকের সিরিয়াল**\nবিশেষজ্ঞের তালিকা:\n{suggested_doctors}\n\nGenerated by Synapse-OS"
        return jsonify({"status": "success", "guideline": fallback})
